...
<head>
    ...
    <title>Mon espace — @yield('title')</title>
...
<!-- TOPBAR -->
<div class="topbar">
    <a href="{{ route('employe.profil') }}" class="brand">
        <div class="brand-icon"><i class="bi bi-person-badge text-white"></i></div>
        <span>
            Mon espace
    ...
    <div class="user-area">
        <div class="user-chip">
            ...
            {{ Auth::user()->name }}
            <span class="role-badge">Employé</span>
        </div>
...
<div class="sidebar">
    ...
    <a href="{{ route('employe.profil') }}" class="{{ request()->routeIs('employe.profil') ? 'active' : '' }}">
        <i class="bi bi-person"></i> Mon profil
    </a>
    <a href="{{ route('employe.conges') }}" class="{{ request()->routeIs('employe.conges*') ? 'active' : '' }}">
        <i class="bi bi-calendar-check"></i> Mes congés
    </a>
    <a href="{{ route('employe.absences') }}" class="{{ request()->routeIs('employe.absences*') ? 'active' : '' }}">
        <i class="bi bi-calendar-x"></i> Mes absences
    </a>

    <div class="nav-section-label">Informations</div>
    <a href="{{ route('employe.reglement') }}" class="{{ request()->routeIs('employe.reglement') ? 'active' : '' }}">
        <i class="bi bi-journal-text"></i> Code du travail
    </a>
</div>
@endauth
